 ...
 * com.hcl.retailbanking.repository.UserRepository; import
 * com.hcl.retailbanking.util.ApiConstant; import
 * com.hcl.retailbanking.util.StringConstant;
 * 
 * 
 * @RunWith(MockitoJUnitRunner.Silent.class) public class UserServiceTest {
 * 
 ...
 * 
 * UserDto userDto = new UserDto(); User user = new User(); RegisterResponseDto
 * registerResponseDto = new RegisterResponseDto(); LoginResponseDto
 * apiLoginInfoDto = new LoginResponseDto();
 * 
 ...
 * 
 * user.setUserId(1); user.setFirstName("Hema"); user.setLastName("Jayakumar");
 * user.setDob(LocalDate.of(1998, 8, 25)); user.setMobileNumber("9894803625");
 * user.setEmail("hema@gmail.com"); user.setTypeOfId("Aadhar");
 * user.setIdProofNumber("IND467"); user.setAge(21); user.setAddress("Chennai");
 * user.setPassword("hemanive"); user.setGender("Female");
 * user.setStatus(StringConstant.USER_STATUS);
 * 
 * account.setAccountNumber(100100L); account.setAccountType("SAVINGS");
 * account.setBalance(1000.0); account.setIfscCode("IN35");
 * account.setUserId(1);
 * 
 ...
 * 
 * Mockito.when(userRepository.getUserByMobileNumber("9894803625")).thenReturn(
 * user); LoginResponseDto apiLoginInfoDtos =
 * userServiceImpl.loginUser("9894803625", "hemanive");
