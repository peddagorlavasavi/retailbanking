...
public class StringConstant {
	...
	public static final String PWD_MANDATORY = "Password is mandatory";
	...
	public static final String PWD_VALIDATION_FAILED = "Please Enter the Password more than 7 characters";
